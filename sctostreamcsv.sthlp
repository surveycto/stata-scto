...
{phang2}{cmdab:sctostreamcsv} {hline 2} This command adds variables to sensor streams files outputted alongside data exported from {browse "https://www.surveycto.com/":SurveyCTO}. The added variables are calculations based on the sensor recordings in those files.
