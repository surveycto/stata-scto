...
* **sctoapi** - downloads SurveyCTO data in JSON format via the API. The data is then converted and saved in CSV and DTA (optional) format. Optionally, it also downloads media files which are saved in a subfolder named 'media'.
